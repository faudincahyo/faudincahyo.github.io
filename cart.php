...
if(!empty($_SESSION['cart'])){
    ...
    foreach($_SESSION['cart'] as $key => $value){
        $outputTable .= "<tr><td>".$value['p_image']."</td><td>".$value['p_name']."</td><td>".($value['p_price'] * $value['p_quantity']) ."</td><td>".$value['p_quantity']."</td><td><button id=".$value['p_id']." class='btn btn-danger delete'>Delete</button></td></tr>";  
