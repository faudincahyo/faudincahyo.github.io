...
<div class="card">
      <div class="row g-0">
        <div class="col-md-4">
        <img class="gambar" src="img/pupuk4.jpg" class="img-fluid rounded-start" alt="Pupuk Fosfat">
        </div>
        ...
        <h2><?php echo $row['name']?></h2>
            ...
            <ul>
                ...
                <li>Pupuk Fosfat mengandung 36% fosfor dalam bentuk P2O5</li>
                <li>Pupuk ini terbuat dari fosfat alam dan sulfat</li>
              </ul>
          </div>
