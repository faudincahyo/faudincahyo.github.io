   ...
   <?php
    ...
    ?>
      ...
      <div class="card">
        <div class="row g-0">
          <div class="col-md-4">
            <img class="gambar" src="img/logo/Promosi_pot2.png" class="img-fluid rounded-start" alt="Pot Keramik">
          </div>
          <div class="col-md-8">

            <div class="card-body" style="align-items: left;">
              <h2><?php echo $row['name']?></h2>
              <p class="text-decoration-line-through small">Rp 550.000,00</p>
              <h4>Rp. <?php echo $row['price']?></h4>
              <ul>
                <li>Kondisi: Baru</li>
                <li>Kategori: Pot Bunga</li>
                <li>Jenis Pot: Pot Berbahan Keramik</li>
                <li>Pot berbahan keramik ini memiliki banyak corak yang unik dan terlihat mewah.</li>
