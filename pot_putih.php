   ...
   <?php
    ...
    ?>
      ...
      <div class="card">
        <div class="row g-0">
          <div class="col-md-4">
            <img class="gambar" src="img/logo/Promosi_pot1.png" class="img-fluid rounded-start" alt="Pot Putih">
          </div>
          <div class="col-md-8">

            <div class="card-body" style="align-items: left;">
              <h2><?php echo $row['name']?></h2>
              <p class="text-decoration-line-through small">Rp 400.000,00</p> 
              <h4>Rp. <?php echo $row['price']?></h4>
              <ul>
                <li>Kondisi: Baru</li>
                <li>Kategori: Pot Bunga</li>
                <li>Jenis Pot: Pot Berbahan Plastik</li>
                <li>Pot berbahan plastik dan berwarna putih ini menampilkan kesan elegan pada tanaman hias anda</li>
              </ul>
            </div>
            <div class="form-group text-center col-md-2">
              <label>Pilih Banyak Barang:</label>  
            <select select class="form-control" id="quantity<?php echo $row['id']?>">
              <center>
              <option>1</option>
              <option>2</option>
              <option>3</option>
