   ...
   <?php
    ...
    ?>
      ...
      <div class="card">
        <div class="row g-0">
          <div class="col-md-4">
            <img class="gambar" src="img/logo/Promosi_pupuk6.jpg" class="img-fluid rounded-start" alt="Pupuk Petroganik">
          </div>
          <div class="col-md-8">

            <div class="card-body" style="align-items: left;">
              <h2><?php echo $row['name']?></h2>
              <p class="text-decoration-line-through small">Rp 200.000,00</p>
              ...
              <ul>
                ...
                <li>Pupuk Petroganik memiliki kandungan pH 4-9 yang dapat menyuburkan tanah.</li>
              </ul>
            </div>
