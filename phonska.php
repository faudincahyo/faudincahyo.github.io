   ...
   <?php
    ...
    ?>
      ...
      <div class="card">
        <div class="row g-0">
          <div class="col-md-4">
            <img class="gambar" src="img/pupuk3.jpg" class="img-fluid rounded-start" alt="Pupuk Phonska">
          </div>
          <div class="col-md-8">
            ...
            <h4>Rp. <?php echo $row['price']?></h4>
              <ul>
                ...
                <li>Jenis Pupuk: Pupuk Organik/ kompos</li>
                <li>Pupuk Phonska merupakan pupuk kompos yang memiliki unsur hara dan air yang baik untuk tanaman</li>
              </ul>
            </div>
