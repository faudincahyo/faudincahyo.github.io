  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          <ul class="navbar-nav m-auto mb-2 mb-lg-0">
            ...
            <li class="counter-container">
              <a class="nav-link menu" id="menuCart" href="shoppingCart.php"><i class="fa fa-shopping-cart keranjang"></i></a>
            </li>
          </ul>
        </div>
      </div>
   ...
   <?php
    ...
    <div class="card">
      <div class="row g-0">
        <div class="col-md-4">
          <img class="gambar"src="img/logo/promosi3.png" class="gambar">
        </div>

        <div class="productContainer col-md-8">
          <div class="cardBody" style="align-items: left;">

            <div class=" judulBrg">
            <h2><?php echo $row['name']?></h2>
            </div>
            <p class="text-decoration-line-through small">Rp 120.000,00</p>
            <div class="harga">
            <h4>Rp. <?php echo $row['price']?></h4>
            </div>
            <ul>
              <li>Kondisi: Baru</li>
              <li>Kategori: Tanaman</li>
              <li>Jenis Tanah: Tanah Humus</li>
              <br>
              <li>Tanaman dikirim beserta pot bunga (seperti pada gambar)</li>
              <li>Tidak termasuk pupuk</li>
              <li>Cocok ditaruh di teras rumah</li>
            </ul>
            </ul>
          </div>
          ...
          <div class="tombol">
            <button id="tekan" type="button" class="btnkeranjang btn btn-outline-danger add" data-id="<?php echo $row['id']?>"><i class="fa fa-shopping-cart"></i> Masukkan ke Keranjang</button>
          </div>
          <?php
    }
  ?>
