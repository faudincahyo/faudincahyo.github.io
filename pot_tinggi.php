   ...
   <?php
    ...
    ?>
      ...
      <div class="card">
        <div class="row g-0">
          <div class="col-md-4">
            <img class="gambar" src="img/pot3.jpg" class="img-fluid rounded-start" alt="Pot Tinggi">
          </div>
          <div class="col-md-8">
            ...
            <div class="card-body" style="align-items: left;">
              ...
              <ul>
                ...
                <li>Pottinggi ini cocok diletakkan di tempat yang sempit. Pot ini terlihat elegan & Futuristic.</li>
