   ...
   <?php
    ...
    ?>
      ...
      <div class="card">
        <div class="row g-0">
          <div class="col-md-4">
            <img class="gambar" src="img/logo/Promosi_pot4.png" class="img-fluid rounded-start" alt="Pot Plastik">
          </div>
          <div class="col-md-8">

            <div class="card-body" style="align-items: left;">
              <h2><?php echo $row['name']?></h2>
              <p class="text-decoration-line-through small">Rp 35.000,00</p>
              <h4>Rp. <?php echo $row['price']?></h4>
              <ul>
                <li>Kondisi: Baru</li>
                <li>Kategori: Pot Bunga</li>
                <li>Jenis Pot: Pot Berbahan plastik</li>
                <li>Pot berbahan plastik ini sering ditemui di teras-teras rumah</li>
                <li>Pot ini memiliki harga terjangkau banyak dicari oleh banyak orang karena desainnya yang sederhana namun dapat mempercantik tanaman anda.</li>
              </ul>
            </div>
