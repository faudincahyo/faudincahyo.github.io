   ...
   <?php
    ...
    ?>
      ...
      <div class="card">
        <div class="row g-0">
          <div class="col-md-4">
            <img class="gambar" src="img/logo/Promosi_plant3.png" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">

            <div class="card-body" style="align-items: left;">
              <h2><?php echo $row['name']?></h2>
              <p class="text-decoration-line-through small">Rp 270.000,00</p>
              <h4>Rp. <?php echo $row['price']?></h4>
              <ul>
                <li>Kondisi: Baru</li>
                <li>Kategori: Pupuk</li>
                <li>Jenis Pupuk: Pupuk Sintetis</li>
                <li>Berat: 50 kg</li>
                <li>Pupuk Mahkota cocok dicampur dengan pupuk organik atau pupuk konvensional</li>
                <li>Pupuk ini mengandung 20% Nirogen dan 23% Sulfur</li>
