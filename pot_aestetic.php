   ...
   <?php
    ...
    ?>
      ...
      <div class="card">
        <div class="row g-0">
          <div class="col-md-4">
            <img class="gambar" src="img/pot6.jpeg" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">
            ...
            <div class="card-body" style="align-items: left;">
              ...
              <ul>
                ...
                <li>Pot putih dengan bentuk seperti kelompak bunga ini terlihat cantik & cocok untuk tanaman anda.</li>
