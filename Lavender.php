  ...
  <body>
   ...
   <?php
    ...
    <div class="card">
      <div class="row g-0">
        <div class="col-md-4">
          <img class="gambar"src="img/logo/promosi2.png" class="gambar">
        </div>

        <div class="col-md-8">
          <div class="card-body" style="align-items: left;">
          <h2><?php echo $row['name']?></h2>
            <h3 class="text-decoration-line-through small">Rp 200.000,00</h3>
            ...
            <ul>
              ...
              <li>Biasa dipakai sebagai pengharum ruangan</li>
            </ul>
            </div>
