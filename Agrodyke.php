...
<html lang="en">
  ...
  ?>
      <div class="card">
        <div class="row g-0">
          <div class="col-md-4">
            <img class="gambar" src="img/pupuk2.jpg" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">
            ...
            <h4>Rp. <?php echo $row['price']?></h4>
              <ul>
                ...
                <li>Jenis Pupuk: Pupuk Organik</li>
                <li>Berat: 3kg</li>
                <li>Pupuk Agroyke cocok dicampur dengan pupuk organik atau pupuk konvensional</li>
                <li>Pupuk yang paling banyak dicari oleh orang</li>
                <li>Cocok untuk berbagai jenis tanaman</li>
              </ul>
            </div>
