...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #6de2b5;">
      ...
      <div class= "container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          <ul class="navbar-nav m-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link menu" id="menuCart" href="cart.html"><i class="fa fa-bell"></i></a>
            </li>
            <li class="nav-item">
      ...
      <form class="d-flex" style="margin-right: 1px;">
   ...
   <?php
    ...
    ?>
      ...
      <div class="card">
        <div class="row g-0">
          <div class="col-md-4">
            <img class="gambar" src="img/logo/Promosi_pupuk1.jpg" class="img-fluid rounded-start" alt="Pupuk Mahkota">
          </div>
          <div class="col-md-8">
            ...
            <div class="card-body" style="align-items: left;">
              ...
              <ul>
                <li>Kondisi: Baru</li>
                <li>Kategori: Pupuk</li>
                <li>Jenis Pupuk: Pupuk Urea</li>
                <li>Berat: 50kg</li>
                <li>Pupuk Urea cocok dicampur dengan pupuk organik atau pupuk konvensional</li>
                <li>Pupuk yang paling banyak dicari oleh orang</li>
                <li>Pupuk Urea dengan konsentrasi sebanyak 46%, baik untuk tanaman</li>
              </ul>
            </div>
